...
def test_workflow(monkeypatch):
    ...
    monkeypatch.setattr("app.api.projects.generate_test_suites_task.delay", lambda project_id, error_types: mock_task)
    ...
    monkeypatch.setattr("app.api.projects.ChainStore", lambda: mock_test_suite_store)
